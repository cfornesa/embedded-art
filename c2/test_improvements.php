...
echo $constants_ok ? "✓ PASS: All constants defined\n" : "✗ FAIL: Missing constants\n";
...
echo $logger_ok ? "✓ PASS: Logger class loaded\n" : "✗ FAIL: Logger class not found\n";
if ($logger_ok) {
...
try {
  ...
  echo $slug_ok ? "✓ PASS: normalize_slug() works\n" : "✗ FAIL: normalize_slug() failed\n";
  echo "  - Generated slug: $slug\n";
  echo $key_ok ? "✓ PASS: generate_admin_key() works\n" : "✗ FAIL: generate_admin_key() wrong length\n";
...
try {
  ...
  echo "✓ PASS: Shape validation accepts valid input\n";
} catch (Exception $e) {
  echo "✗ FAIL: " . $e->getMessage() . "\n";
}
...
try {
  ...
  echo "✗ FAIL: Shape validation should reject invalid type\n";
} catch (Exception $e) {
  echo "✓ PASS: Shape validation correctly rejects invalid type\n";
...
try {
  ...
  echo $db_ok ? "✓ PASS: Database connection healthy\n" : "⚠ WARNING: Database not connected\n";
  echo "  - Driver: $driver\n";
